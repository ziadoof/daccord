...
class AddSOspecificationFieldSubscriber implements EventSubscriberInterface

{
    ...
    private function addSOspecificationForm($form, $category)
    {

        if ($category!== null) {
            $specifications = $category->getSospecifications();
    ...
    public function preSetData(FormEvent $event)
    {
        ...
        $this->addSOspecificationForm($form, $category_id);
    }
    ...
    public function preSubmit(FormEvent $event)
    {
        ...
        $this->addSOspecificationForm($form, $category);
    }
