...
class AddSDspecificationFieldSubscriber implements EventSubscriberInterface

{
    ...
    private function addSDspecificationForm($form, $category)
    {

        if ($category!== null) {
            $specifications = $category->getSdspecifications();
    ...
    public function preSetData(FormEvent $event)
    {
        ...
        $this->addSDspecificationForm($form, $category_id);
    }
    ...
    public function preSubmit(FormEvent $event)
    {
        ...
        $this->addSDspecificationForm($form, $category);
    }
