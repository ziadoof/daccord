 ...
 */
final class Version20190312131544 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ospecification (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, name VARCHAR(255) NOT NULL, label VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, text_options LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', numeric_options LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', type_of_choice VARCHAR(255) DEFAULT NULL, min_option INT DEFAULT NULL, max_option INT DEFAULT NULL, INDEX IDX_AB91E0012469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ospecification ADD CONSTRAINT FK_AB91E0012469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ospecification DROP FOREIGN KEY FK_AB91E0012469DE2');
        ...
        $this->addSql('DROP TABLE ospecification');
    }
}
