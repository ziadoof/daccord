 ...
 */
final class Version20190123133712 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad DROP ad_number');
        $this->addSql('ALTER TABLE ad ADD CONSTRAINT FK_77E0ED58908E2FFE FOREIGN KEY (specification_id) REFERENCES specification (id)');
        ...
        $this->addSql('ALTER TABLE specification ADD CONSTRAINT FK_E3F1A9A8BAC62AF FOREIGN KEY (city_id) REFERENCES city (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE specification DROP FOREIGN KEY FK_E3F1A9A8BAC62AF');
        ...
        $this->addSql('ALTER TABLE ad DROP FOREIGN KEY FK_77E0ED58908E2FFE');
        $this->addSql('ALTER TABLE ad ADD ad_number INT NOT NULL');
    }
}
