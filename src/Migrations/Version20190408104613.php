 ...
 */
final class Version20190408104613 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad ADD generalcategory_id INT DEFAULT NULL, DROP parent_category_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad ADD parent_category_id INT NOT NULL, DROP generalcategory_id');
    }
}
