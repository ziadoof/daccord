...
class MeetupController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            //new photo code
            if (!empty($_POST['meetupImage'])){
                if ($_POST['meetupImage'][0] !== null){
                    $file_name = $this->generateUniqueFileName();
                    $image = $this->base64ToImage($_POST['meetupImage'][0],'assets/images/meetup/'.$file_name.'.jpg');
                }
            }
            // upload new photo
            $image ? $meetup->setImage($file_name.'.jpg'):$meetup->setImage(null);
            //end new photo code
