...
/**
 * @ORM\Entity(repositoryClass="App\Repository\DspecificationRepository")
 */
class Dspecification
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Category", inversedBy="dspecifications")
