...
t.add("fos_user.username.already_used", "Username d\u00e9j\u00e0 pris", "validators", "fr");
t.add("fos_user.username.blank", "Le nom d'utilisateur ne peut pas \u00eatre vide", "validators", "fr");
...
t.add("fos_user.email.already_used", "Email d\u00e9j\u00e0 pris", "validators", "fr");
t.add("fos_user.email.blank", "L'email ne peut pas \u00eatre vide", "validators", "fr");
t.add("fos_user.email.short", "L'email est trop court", "validators", "fr");
t.add("fos_user.email.long", "L'email est trop long", "validators", "fr");
t.add("fos_user.email.invalid", "Email invalide", "validators", "fr");
t.add("fos_user.password.blank", "Le mot de passe ne peut pas \u00eatre vide", "validators", "fr");
t.add("fos_user.password.short", "Le mot de passe est trop court", "validators", "fr");
t.add("fos_user.password.mismatch", "Le mot de passe ne correspond pas", "validators", "fr");
...
t.add("fos_message.recipient.blank", "Pas de destinataire sp\u00e9cifi\u00e9", "validators", "fr");
t.add("fos_message.recipients.blank", "Pas de destinataires sp\u00e9cifi\u00e9", "validators", "fr");
t.add("fos_message.subject.blank", "Vous devez entrer un sujet", "validators", "fr");
t.add("fos_message.subject.short", "Le sujet est trop court|Le sujet est trop court", "validators", "fr");
t.add("fos_message.subject.long", "Le sujet est trop long|Le sujet est trop long", "validators", "fr");
t.add("fos_message.body.blank", "Vous devez entrer un message", "validators", "fr");
t.add("fos_message.body.short", "Le message est trop court", "validators", "fr");
t.add("fos_message.body.spam", "Il semble que votre message soit un SPAM, il n'a pas \u00e9t\u00e9 envoy\u00e9", "validators", "fr");
t.add("fos_message.not_authorized", "Vous n'avez pas le droit d'envoyer ce message", "validators", "fr");
t.add("fos_message.reply_not_authorized", "Vous n'avez pas de droit de r\u00e9pondre dans cette discussion", "validators", "fr");
t.add("fos_message.self_recipient", "Vous ne pouvez pas vous envoyer un message \u00e0 vous-m\u00eame", "validators", "fr");
t.add("You must enter numbers only.", "Vous ne devez saisir que des chiffres.", "validators", "fr");
t.add("Email d\u00e9j\u00e0 pris", "Email d\u00e9j\u00e0 pris", "validators", "fr");
t.add("Username d\u00e9j\u00e0 pris", "Username d\u00e9j\u00e0 pris", "validators", "fr");
})(Translator);
